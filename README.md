...
running command...
$ gfh (--version)
gfh/0.0.4 linux-x64 node-v20.9.0
$ gfh --help [COMMAND]
USAGE
  $ gfh COMMAND
...
...
_See code: [src/commands/hello/index.ts](https://github.com/gfh/gfh/blob/v0.0.4/src/commands/hello/index.ts)_
...
_See code: [src/commands/hello/world.ts](https://github.com/gfh/gfh/blob/v0.0.4/src/commands/hello/world.ts)_
